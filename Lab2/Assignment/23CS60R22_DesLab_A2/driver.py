...
def medalTableSubMenu():
    ...
    while True:
        ...
        if choice == 1:
            ...
            # Checking whether the country has multiple medal winner or not
            if 'Multiple medal winner' not in data_Dictionary[country].keys():
                print("No multiple medal winner for ", country)
                continue
